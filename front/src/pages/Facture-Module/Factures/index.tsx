...
function Main() {
    ...
    const refreshTab = async () => {
        factureService.factureList().then((x: any) => {
            factures = x;
            initTabulator();
    ...
    const handleDelete = (id: string) => {
        factureService.deleteFacture(id).then(async (x) => {
    ...
    const handleInvoiceClick = (id: string) => {
        window.open("/invoices/detail/" + id, "_blank");
    }
                    ...
                    },
                    {
                        ...
                        formatter(cell) {
                            const a = stringToHTML(`<div class="flex lg:justify-center items-center">
                                                      ...
                                                      <a class="detail flex items-center mr-3" href="javascript:;">
                                                        <i data-lucide="table" class="w-4 h-4 mr-1"></i> Details
                                                      </a>
                                                      <a class="invoice flex items-center mr-3" href="javascript:;">
                            ...
                            a.addEventListener("click", function (e) {
                                ...
                                // @ts-ignore
                                if (clickedElement.className.includes("detail")) {
                                    // @ts-ignore
                                    handleDetailClick(cell.getData()._id);
                                }
                                // On click actions
                            });
                            return a;
    ...
    return (
        <>
            <div className="flex flex-col items-center mt-8 intro-y sm:flex-row">
                <h2 className="mr-auto text-lg font-medium">Invoices</h2>
                ...
                <div className="flex flex-col sm:flex-row sm:items-end xl:items-start">
                    ...
                    >
                        <div className="items-center sm:flex sm:mr-4">
                            ...
                            >
                                <option value="num_facture">Number</option>
                                <option value="total">Price</option>
                                <option value="qte">Quantity</option>
                                <option value="fournisseur.title">Supplier</option>
                            </FormSelect>
                        </div>
