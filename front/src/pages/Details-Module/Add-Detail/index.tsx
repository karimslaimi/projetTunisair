...
function main() {
    ...
    const formSubmit = async (event: React.ChangeEvent<HTMLFormElement>) => {
        ...
        if (!result) {
            ...
            detailsService.addDetail(data).then((result: any) => {
                console.log(result);
                if (result) {
    ...
    return (
        <>
            <div className="flex items-center mt-8 intro-y">
                <h2 className="mr-auto text-lg font-medium">Add Detail</h2>
            </div>
            ...
            >
                ...
                <div className="ml-4 mr-4">
                    <div className="font-medium">Adding a detail failed!</div>
